...
本文档包含主技能说明中未涵盖的高级 PDF 处理功能、详细示例和额外库。

## pypdfium2 库（Apache/BSD 许可证）

### 概述
pypdfium2 是 PDFium（Chromium 的 PDF 库）的 Python 绑定。它非常适合快速 PDF 渲染、图片生成，可作为 PyMuPDF 的替代品。
